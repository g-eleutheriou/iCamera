...
function onLoad() {
    ...
    $("#settings_ok_button").bind("vclick", applySettings); 
    $("#settings_cancel_button").bind("vclick", restoreSettings); 
    
    
// iscroll plugin for result page    
...
function onDeviceReady() {
    ...
    $("#open_camera_button").bind ("vclick", onCapture);
    $("#open_lib_button").bind ("vclick", onCapture);
    $("#open_alb_button").bind ("vclick", onCapture);
    $("#home_button").bind("vclick", removeTemporaryFiles); 
}
